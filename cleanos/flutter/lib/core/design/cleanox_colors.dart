...
class CleanoxColors extends ThemeExtension<CleanoxColors> {
  ...
  static const CleanoxColors light = CleanoxColors(
    ...
    statusAgendada: Color(0xFF3B82F6),
    statusAtribuida: Color(0xFF8B5CF6),
    statusEmAndamento: Color(0xFFF59E0B),
    statusConcluida: Color(0xFF22C55E),
    statusCancelada: Color(0xFFEF4444),
    ...
    groupPromocao: Color(0xFFF59E0B),
    groupAdicional: Color(0xFF2563EB),
    groupAvulsos: Color(0xFFFF8C42),
    groupSofa: Color(0xFFC084FC),
    groupColchao: Color(0xFFC084FC),
    groupOutros: Color(0xFF64748B),
    finIncome: Color(0xFF22C55E),
    finExpense: Color(0xFFEF4444),
    finInfo: Color(0xFF3B82F6),
    finMuted: Color(0xFF7A8893),
    finSeries: [
      Color(0xFF00C2B8),
      Color(0xFF22C55E),
      Color(0xFF3B82F6),
